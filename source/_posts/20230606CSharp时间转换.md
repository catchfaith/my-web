...
//获取当前时间所在的这个月的第一天0点0分0秒和这个月的最后一天23.59.59s
var datetime =DateTime.Now;
 var beginTime = dateTime.AddDays(1 - dateTime.Day).Date;
 var endTime = dateTime.AddDays(1 - dateTime.Day).Date.AddMonths(1).AddSeconds(-1);
```